...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle("Calvin Gozé");
    this.meta.updateTag({name: 'description',content: "My name is Calvin Gozé. I'm an engineering student, and a self taught software developer. "+
